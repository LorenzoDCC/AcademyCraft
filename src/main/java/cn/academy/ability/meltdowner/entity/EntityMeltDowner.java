...
//		System.out.println(rawBound);
    ...
    private boolean canSeeEachOther(Entity e1, Entity e2) {
    	...
    	return this.worldObj.rayTraceBlocks(Vec3.createVectorHelper(	e1.posX, e1.posY + e1.getEyeHeight(), e1.posZ),
    			Vec3.createVectorHelper(e2.posX, e2.posY + e2.getEyeHeight(), e2.posZ)) == null;
    }
